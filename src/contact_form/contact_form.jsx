...
const placeholdersList = contactForms.map((placeholder, index) => {
    return (
        <div key={placeholder.name} className='contact_form_item_inner'>
            ...
            {placeholder.isBig ?
                < textarea className='input_text_global_pad form_item_input big_form_input' name='contact_form_item' id={placeholder.name} placeholder={placeholder.placeholder} required />
