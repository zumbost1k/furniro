      ...
      <section className='paginate_section'>
        <div className='paginate_filter'>
          <div className='paginate_filter_item'>
            ...
            <div className='pages_number'>{`Showing ${itemOffset + 1}-${
              itemOffset + parseInt(itemsPerPage) >= productsList.length
                ? productsList.length
                : itemOffset + parseInt(itemsPerPage)
            } of ${productsList.length} results`}</div>
          </div>
          <div className='paginate_filter_item'>
            ...
            <div className='filter_number_item'>
              ...
              <select
                ...
                onChange={(newState) => {
                  setFilterOn(newState.target.value);
                }}
              >
