...
import { changeNumberProduct, deleteProduct, useTotalCost } from '../features/todo/todoSlice';
        ...
        <section className='cart_total_section'>
                    ...
                    {products.map(product => {
                        ...
                        return (
                            <div className='cart_total_item'>
                                <div className='cart_item_back'><img className='cart_item_photo' width='105' height='105' src={`/photos/products/${product.info.path}`} alt={product.info.name} /></div>
                                <p className='cart_item_name cart_item_text'>{product.info.name}</p>
                                <p className='cart_item_cost cart_item_text'>Rs. {product.info.cost}</p>
                                ...
                                />
                                <p className='cart_item_total_cost cart_item_text'>Rs. {costChecker(product.info.cost, product.number)}</p>
            ...
            <div className='cart_total_info_block'>
                ...
                <div className='total_cost_block_item subtotal_info_item'>
                    ...
                    <p className='cart_subtotal_cost_value'>Rs. {totalCost}</p>
                </div>
                <div className='total_cost_block_item total_info_item'>
                    <p className='cart_total_cost_text'>Total</p>
                    <p className='cart_total_cost_value'>Rs. {totalCost}</p>
                </div>
