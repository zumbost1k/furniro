  ...
  return (
    <section className='slider_section'>
      <div className='inspiration_block'>
        ...
        <button type='button' className='inspiration_button'>
          Explore More
        </button>
      </div>
            ...
            return (
              <div key={slide.title} className='slider'>
                ...
                <div className='slide_block'>
                  ...
                  <div>
                    <button type='button' className='slide_caption_button'>
                      <svg
                        width='24'
                        height='24'
                        viewBox='0 0 24 24'
